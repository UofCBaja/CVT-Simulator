...
export type RunStreamBody = NonNullable<
  operations["run_stream_run_stream_post"]["requestBody"]
>["content"]["application/json"];
// TODO: Do we need these 3 types separately?
export type StreamProgressMessage =
  components["schemas"]["StreamProgressMessage"];
export type StreamCompleteMessage =
  components["schemas"]["StreamCompleteMessage"];
...
export type StreamMessage =
  operations["run_stream_run_stream_post"]["responses"]["200"]["content"]["application/json"];
...
export type SolversBody = NonNullable<
  operations["run_solvers_solvers_post"]["requestBody"]
>["content"]["application/json"];
...
export type RampPreviewBody = NonNullable<
  operations["preview_ramp_ramp_preview_post"]["requestBody"]
>["content"]["application/json"];
export type RampPreviewResponse =
  operations["preview_ramp_ramp_preview_post"]["responses"]["200"]["content"]["application/json"];

export async function previewRamp(
  body: RampPreviewBody,
): Promise<RampPreviewResponse> {
